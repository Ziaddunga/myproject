...
import 'package:myproject/motherBoardDetails_screen.dart';
            ...
            children: [
              ...
              ListView.separated(
                ...
                itemBuilder: (context, index) => InkWell(
                    onTap: () => Get.to(() => MotherBoardDetailsScreen(),
                        arguments: motherBoard[index]),
                    child: buildMotherBoardItem(motherBoard[index])),
